...
namespace Opertoon.Panoply {
	...
	public class PanoplyController: MonoBehaviour {
		...
		public Vector2 accelerometerCenter = new Vector2 (-.2f, 0);
	    ...
	    public void UpdatePassiveInput() {
			...
			if (passiveInput) {
				...
				case PassiveInputType.Accelerometer:
					acceleration.x = Mathf.InverseLerp (accelerometerCenter.x - accelerometerRange.x, accelerometerCenter.x + accelerometerRange.x, Input.acceleration.x);
					acceleration.y = Mathf.InverseLerp (accelerometerCenter.y - accelerometerRange.y, accelerometerCenter.y + accelerometerRange.y, Input.acceleration.y);
